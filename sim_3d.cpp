...
int main(int argc, char const *argv[])
{
    ...
    float x_start = 0; float x_end = 10; unsigned long nx = 101;
    float y_start = 0; float y_end = 10; unsigned long ny = 101;
    float z_start = 0; float z_end = 10; unsigned long nz = 101;
    ...
    std::cout << "Need atleast: " << (nx*ny*nz*nt*sizeof_float + nx*ny*nz*sizeof_float) / 1073741824.0 << " GB \n \n";
